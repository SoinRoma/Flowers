$(document).ready(function () {
    ...
    $("#review-1").on('click', function () {
        $.fancybox.open([
            {
                src: './images/fancybox/fancybox1.jpg',
                opts: {
                    caption: 'Первый букет',
                    thumb: './images/fancybox/fancybox1.jpg'
                }
            },
            {
                src: './images/fancybox/fancybox2.jpg',
                opts: {
                    caption: 'Второй букет',
                    thumb: './images/fancybox/fancybox2.jpg'
                }
            }
        ], {
            loop: true,
    ...
    $("#review-2").on('click', function () {
        $.fancybox.open([
            {
                src: './images/fancybox/fancybox3.jpg',
                opts: {
                    caption: 'Первый букет',
                    thumb: './images/fancybox/fancybox3.jpg'
                }
            },
            {
                src: './images/fancybox/fancybox4.jpg',
                opts: {
                    caption: 'Второй букет',
                    thumb: './images/fancybox/fancybox4.jpg'
                }
            }
        ], {
            loop: true,
